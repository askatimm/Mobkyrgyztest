...
class LevelA1Tasks extends StatelessWidget {
  final String imageUrl;
  final String levelId;

  // 3. ❗ Конструктор принимает levelId
  LevelA1Tasks({super.key, required this.imageUrl, required this.levelId});
                  ...
                  return ListView(
                    ...
                    children: snapshot.data!.docs.map((
                      ...
                      String instructionKey =
                          data['instruction'] ??
                          (data['instruction_key']?.toString().tr() ?? 'lex_gram_instructions');
                      return Padding(
